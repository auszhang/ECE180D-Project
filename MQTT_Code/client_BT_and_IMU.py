...
def on_message(client, userdata, msg):
		...
		if (str(statement) == "Mode 1"):
			...
			print("Enacting lights with color")
			MY_CURRENT_LIGHTING = LED.enact_lights_with_color_tilt(pixels,str(statement), tiltHeading, MY_ID)
		else:
			MY_CURRENT_LIGHTING = LED.enact_lights_basic_tilt(pixels, str(statement), tiltHeading, MY_ID)
